   ...
   displayArtistList(artists) {
        ...
        for (let artist of artists) {
            ...
            clickOnArtist.addEventListener('click', function() {
                ...
                FetchModel.deleteAnArtist(this);
            });
    ...
    deleteArtistDiv: document.getElementById('deleteAnArtist'),

    deleteAnArtist(element){
        const deleteButton = document.createElement('button');
        deleteButton.innerText = 'Delete this artist';
        deleteArtistDiv.appendChild(deleteButton);
        deleteButton.onclick = FetchModel.deleteArtist();
    },

    addAlbumDiv: document.getElementById('addAlbum'),
    ...
    addAlbumToArtistId(element) {
        ...
        Controller.createAlbum(addAlbumButton, albumButton);
    },
    ...
    addTrackToPlaylist(songTrack) {
        ...
        addPlaylistButton.onclick = Controller.createPlaylist()      
    },
